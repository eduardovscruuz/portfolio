...
const carouselData = [
  {
    ...
    linkGit:
      "https://www.linkedin.com/posts/eduardovscruuz_nextjs-typescript-tailwind-activity-7377061837491646465-Pw_n?utm_source=share&utm_medium=member_desktop&rcm=ACoAADXPZeIBcZV6CfEiKhPopYoXEhC_fKl3Vm0",
    linkSite: "https://www.laboclinlab.com.br",
...
meText2:
 ...
 skillsTitle: "Skills",
    ...
    chat1: "Let's chat!",
    chat2:
      "Wheter you have a question, want to start new project, or simply wants to connect.",
    chat3:
...
meText2:
  'Atualmente atuo como Desenvolvedor Júnior na <a href="https://connectsea.com.br" target="_blank"><b>ConnectSea</b></a>, participando da construção de sistemas usados em operações reais de logística portuária e comércio exterior. Tenho como foco escrever código limpo, escalável e eficiente, priorizando soluções bem pensadas e fáceis de manter, sempre buscando clareza e decisões técnicas que façam sentido no longo prazo.',
    ...
    chat2:
      "Se você tiver uma pergunta, quiser começar um novo projeto ou simplesmente se conectar.",
    chat3:
...
function changeLanguage(lang) {
  document
    ...
    .setAttribute("placeholder", translations[lang].name_placeholder);
  document
    .getElementById("email_input")
    .setAttribute("placeholder", translations[lang].email_placeholder);
  document
    .getElementById("subject_input")
    .setAttribute("placeholder", translations[lang].subject_placeholder);
  document
    .getElementById("message_input")
    .setAttribute("placeholder", translations[lang].message_placeholder);
  document
    .getElementById("form_button")
    .setAttribute("value", translations[lang].submit_value);
